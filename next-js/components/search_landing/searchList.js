		...
		<div className={searchStyle["col-lg-10"]}>
			...
			<div className={searchStyle["body-text"]}>
				<div className={searchStyle["filters-dropdown"]}>
					<div className={searchStyle["gsc-result-info"]}>
						About {totalPages.total ? totalPages.total : 0} results
					</div>
				...
				{isLoading ? (
					...
					<>
						{filterList.map((item, i) => (
							<div
								key={i}
								className={searchStyle["gsc-webResult"] + " " + searchStyle["gsc-result"]}
							>
						...
						<ul className="pagination justify-content-center">
							{totalPages.total > 10
								? arrRange?.map((v, i) => (
										<li
											key={i}
											className={active == v ? "page-item active" : "page-item"}
										>
											<span
												className="page-link"
												onClick={() => searchData(v)}
											>
												{v}
											</span>
										</li>
